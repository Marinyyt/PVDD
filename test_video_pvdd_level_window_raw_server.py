...
from models.networks.models_rvidenet_raw_net import RViDeNet_levelraw
from models.networks.models_level_RAW import FastDVDnetraw
# from models.networks.models_level import FastDVDnet_level
from models.networks.models_cnn_RAW_net import ModifiedDnCNN_levelraw
from models.networks.EDVR_arch_RAW_net import EDVR_levelraw
...
def test_fastdvdnet(**args):
	...
	# model_temp = EDVR_levelraw()
	# model_temp = FastDVDnetraw()
	# model_temp = ModifiedDnCNN_levelraw()
	model_temp = RViDeNet_levelraw()
	# Load saved weights
