...
from models.networks.realbasicvsr_net import ResUNet2
...
class pvdd0815level(BaseNet):
    ...
    def __init__(self, num_in = 3,  num_feat=64, num_block=1, num_block_f=5, num_block_pre = 3, spynet_path=None,
                ...
                drop_path = 0., norm_layer = nn.LayerNorm):
        super(pvdd0815level, self).__init__()
        ...
        self.clean_model = ResUNet2(input_nc=num_in, depth=2, num_feat=num_feat, num_block=num_block_pre)
    ...
    def process(self, x):
        ...
        feats_ = feats_.view(-1, 1, self.num_feat, h_, w_)
