...
class Stylegan2Discriminator(BaseNet):
    def __init__(self,
                 size,
        ...
        if multi_scale:
            ...
            self.final_linear = nn.Sequential(
                EqualLinear(channels[4] * pool_size * pool_size, channels[4], activation='fused_lrelu'),
    ...
    def forward(self, input):
        if not self.get_feats:
            out = self.convs(input)
        else:
            feats = self._unfold(input)
            out = feats[-1]
